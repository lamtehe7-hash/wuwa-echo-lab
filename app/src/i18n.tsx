...
const DICT: Record<string, Entry> = {
  ...
  'cleanup.desc.r3': { vi: 'Loại echo có RV (giá trị roll) thấp hơn ngưỡng bên dưới.', en: 'Removes echoes whose roll value (RV) is below the threshold.' },
  'cleanup.desc.r4': { vi: 'Mỗi nhóm set + cost chỉ giữ N echo RV cao nhất, loại phần dư.', en: 'Keeps only the top-N RV echoes per set + cost group, flags the surplus.' },
  ...
  'anchor.toggleOff': { vi: 'Bỏ neo', en: 'Remove anchor' },
  'anchor.summary': { vi: 'Đã neo {n}/5 · cost {cost}/12', en: 'Anchored {n}/5 · cost {cost}/12' },
  'anchor.clearAll': { vi: 'Bỏ neo tất cả', en: 'Clear all anchors' },
  'anchor.capCount': { vi: 'Đã neo tối đa 5 echo', en: 'Max 5 anchored echoes' },
  ...
  'buildcost.teaser': { vi: 'còn thiếu {tuners} Tuner · {exp} EXP', en: '{tuners} Tuner · {exp} EXP to go' },
